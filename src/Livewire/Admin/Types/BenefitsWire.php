...
namespace GIS\EditableBenefitsBlock\Livewire\Admin\Types;
...
class BenefitsWire extends Component implements SimpleItemActionsInterface
{
    ...
    public function render(): View
    {
        ...
        return view("ebb::livewire.admin.types.benefits-wire", compact("items"));
    }
}
